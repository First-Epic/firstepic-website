      ...
      <section className="relative min-h-screen flex flex-col justify-center items-center px-6 pt-24 pb-12 overflow-hidden">
        ...
        <div className="relative z-10 max-w-5xl text-center">
          <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full border border-white/10 bg-white/5 mb-10 backdrop-blur-sm">
            ...
            <span className="font-mono text-[10px] tracking-widest uppercase text-gray-400">For Production & VFX Studios - Accepting Clients</span>
          </div>

          <h1 className="text-5xl md:text-7xl lg:text-8xl font-bold tracking-tighter mb-8 leading-[0.9]">
            <div>SCALE YOUR PIPELINE.</div>
            <div className="text-gray-500">ACCELERATE DELIVERY.</div>
          </h1>
          ...
          <div className="grid grid-cols-2 gap-6 max-w-xl mx-auto mb-12">
            <div className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-sm p-6 hover-card hover-glow text-center">
              ...
              <div className="text-gray-400 text-sm font-mono uppercase tracking-wider">Freelance Flake-Outs</div>
            </div>
            <div className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-sm p-6 hover-card hover-glow text-center">
          ...
          <div>
            <div className="relative">
              ...
              <div className="relative bg-[#050505] border border-white/10 p-8 rounded-sm shadow-2xl">
                <div className="font-mono text-[10px] text-gray-500 uppercase tracking-widest mb-4">The Studio Trap vs. First Epic</div>
                <ul className="space-y-6">
                  ...
                  <li className="flex gap-4">
                    ...
                    <div>
                      ...
                      <div className="text-gray-500 text-sm">Hidden compliance fees, wage inflation, and unreliable middlemen draining your post-production margins.</div>
                    </div>
                  </li>
                  <li className="flex gap-4">
      ...
      <section id="roles" className="scroll-mt-32 py-32 border-t border-white/5 bg-[#080808]">
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center max-w-3xl mx-auto mb-16">
            ...
            <h3 className="text-3xl md:text-5xl font-bold mb-6">A Glimpse of<br /><span className="text-gray-600">Our Studio Bench.</span></h3>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div className="bg-white/5 border border-white/10 p-8 rounded-sm hover:border-white/20 transition">
              <div className="text-blue-500 font-mono text-xs uppercase tracking-widest mb-4">Visual Effects</div>
              <h4 className="text-xl font-bold text-white mb-4">Motion Graphics & VFX</h4>
              <ul className="space-y-2 text-gray-400 text-sm">
                <li>After Effects Mastery</li>
                <li>ComfyUI Workflows</li>
                <li>Motion Tracking & Rotoscoping</li>
                <li>Compositing</li>
              </ul>
            </div>
            <div className="bg-white/5 border border-white/10 p-8 rounded-sm hover:border-white/20 transition">
              <div className="text-blue-500 font-mono text-xs uppercase tracking-widest mb-4">Editorial & Finish</div>
              <h4 className="text-xl font-bold text-white mb-4">Post-Production Editors</h4>
              <ul className="space-y-2 text-gray-400 text-sm">
                <li>Premiere Pro Editors</li>
