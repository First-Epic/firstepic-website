  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        track('contact_form_submitted', { page: 'tech' })
      } else {
        setStatus('error')
      }
    } catch {
      ...
      <section className="relative min-h-screen flex flex-col justify-center items-center px-6 pt-24 pb-12 overflow-hidden">
        ...
        <div className="relative z-10 max-w-5xl text-center">
          <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full border border-white/10 bg-white/5 mb-10 backdrop-blur-sm">
            ...
            <span className="font-mono text-[10px] tracking-widest uppercase text-gray-400">For Tech Companies & SaaS Startups - Accepting Clients</span>
          </div>
          ...
          <div className="grid grid-cols-2 gap-6 max-w-xl mx-auto mb-12">
            ...
            <div className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-sm p-6 hover-card hover-glow text-center">
              ...
              <div className="text-gray-400 text-sm font-mono uppercase tracking-wider">Codebase Security</div>
            </div>
          </div>
        </div>
      </section>
      ...
      <section id="why" className="scroll-mt-32 min-h-screen flex items-center py-24 relative border-t border-white/5 bg-[#080808]">
        <div className="max-w-7xl mx-auto px-6 grid md:grid-cols-2 gap-16 items-center">
          <div className="relative z-10">
            <div className="font-mono text-xs text-blue-500 mb-6 tracking-widest uppercase">/// Built by a Tech Founder Who's Been In Your Shoes</div>
            <h2 className="text-3xl md:text-5xl font-bold leading-tight mb-8">
              AI makes GitHubs unreliable.<br />
          ...
          <div>
            <div className="relative">
              ...
              <div className="relative bg-[#050505] border border-white/10 p-8 rounded-sm shadow-2xl">
                <div className="font-mono text-[10px] text-gray-500 uppercase tracking-widest mb-4">The Outsourcing Trap vs. First Epic</div>
                <ul className="space-y-6">
                  <li className="flex gap-4">
                    ...
                    <div>
                      ...
                      <div className="text-gray-500 text-sm">Fragmented gig platforms force developers into silos and destroy institutional memory when contracts end.</div>
                    </div>
                  </li>
                  <li className="flex gap-4">
                    ...
                    <div>
                      ...
                      <div className="text-gray-500 text-sm">Hidden EOR compliance fees, wage inflation, and overemployed devs moonlighting on your dime.</div>
                    </div>
                  </li>
                  <li className="flex gap-4">
                    ...
                    <div>
                      ...
                      <div className="text-gray-500 text-sm">Dedicated AI Software Engineers. Absolute code security. Professionally managed studio. One flat monthly rate.</div>
                    </div>
                  </li>
                </ul>
              </div>
        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div className="bg-white/5 border border-white/10 p-8 rounded-sm hover:border-white/20 transition">
              ...
              <p className="text-gray-400 text-sm leading-relaxed">You provision the software seats. You retain 100% ownership of your proprietary code. Zero "Shadow AI".</p>
            </div>
            <div className="bg-white/5 border border-white/10 p-8 rounded-sm hover:border-white/20 transition">
      ...
      <section id="roles" className="scroll-mt-32 py-32 border-t border-white/5 bg-[#080808]">
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center max-w-3xl mx-auto mb-16">
            ...
            <h3 className="text-3xl md:text-5xl font-bold mb-6">A Glimpse of<br /><span className="text-gray-600">Our Engineering Bench.</span></h3>
          </div>

          <div className="grid md:grid-cols-3 gap-8">
            <div className="bg-white/5 border border-white/10 p-8 rounded-sm hover:border-white/20 transition">
              <div className="text-blue-500 font-mono text-xs uppercase tracking-widest mb-4">Core Engineering</div>
              <h4 className="text-xl font-bold text-white mb-4">Full-Stack Engineers</h4>
              <ul className="space-y-2 text-gray-400 text-sm">
                <li>React, Next.js, Node.js</li>
                <li>API Architecture</li>
                <li>Frontend / Backend Scaling</li>
                <li>Mobile (iOS, Android, React Native)</li>
              </ul>
            </div>
            <div className="bg-white/5 border border-white/10 p-8 rounded-sm hover:border-white/20 transition">
              <div className="text-blue-500 font-mono text-xs uppercase tracking-widest mb-4">Infrastructure</div>
              <h4 className="text-xl font-bold text-white mb-4">Backend & DevOps</h4>
              <ul className="space-y-2 text-gray-400 text-sm">
                <li>Python & Rust</li>
                <li>AWS / GCP Cloud Architecture</li>
                <li>Database Management</li>
                <li>CI/CD Pipelines</li>
              </ul>
            </div>
            <div className="bg-white/5 border border-white/10 p-8 rounded-sm hover:border-white/20 transition">
              <div className="text-blue-500 font-mono text-xs uppercase tracking-widest mb-4">AI & Automation</div>
              <h4 className="text-xl font-bold text-white mb-4">AI Integrations</h4>
              <ul className="space-y-2 text-gray-400 text-sm">
                <li>LLM API Wranglers (OpenAI, Claude)</li>
      ...
      <section id="contact" className="scroll-mt-32 min-h-[80vh] flex flex-col justify-center items-center py-24 px-6 relative border-t border-white/5 bg-[#030303]">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-xl text-gray-400 mb-12 max-w-xl mx-auto">
            Drop a dedicated, pre-vetted AI Software Engineer into your Slack by next week. Book a discovery call with Davis.
          </p>
          ...
          <div className="bg-white/5 border border-white/10 p-10 rounded-sm hover-card max-w-lg mx-auto backdrop-blur-sm">
            {status === 'success' ? (
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div>
                  <textarea placeholder="What engineering role are you trying to fill?" rows={3} value={formData.message} onChange={(e) => setFormData({ ...formData, message: e.target.value })} required className="w-full bg-transparent border-b border-white/20 py-3 text-white placeholder-gray-500 focus:border-blue-500 focus:outline-none transition resize-none"/>
                </div>
